...
## [1.0.20251126] - 2025-11-26

### Changed
- Updated ClearURLs rules to version from 2025-11-26
- Rules fetched from https://rules2.clearurls.xyz/data.minify.json
- Recompiled with latest tracking parameter definitions
